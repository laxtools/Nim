							...
							L5: do {
								F.line = 3974;
									...
									if (!(i_184682 < l_184684)) break L6;
										...
										F.line = 3977;
										failed_assert_impl_57280(makeNimstrLit("/Users/travis/build/nim-lang/Nim/lib/system.nim(3977, 11) `len(a) == L` seq modified while iterating over it"));
										}
...
function nsuToLowerAsciiChar(c_164157) {
	var result_164158 = 0;

	var F={procname:"strutils.toLowerAscii",prev:framePtr,filename:"../../lib/pure/strutils.nim",line:0};
	framePtr = F;
		if ((ConstSet2[c_164157] != undefined)) {
		F.line = 265;
		result_164158 = chckRange(addInt(c_164157, 32), 0, 255);
		}
		else {
			F.line = 267;
			result_164158 = c_164157;
		}
		
	framePtr = F.prev;

	return result_164158;
